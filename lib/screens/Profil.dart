...
import 'package:mira/Screens/Support.dart';
...
class _ProfileWidgetState extends State<Profile> {
  ...
  void navigateToEditProfile(User currentUser) {
    Navigator.of(context).push(MaterialPageRoute(
      builder: (context) => EditprofilWidget(currentUser: currentUser),
    ));
  }
              ...
              children: [
                ...
                Padding(
                  ...
                  child: GestureDetector(
                    onTap: () => navigateToEditProfile(User as User),
                    child: Container(
                      width: double.infinity,
                      height: 60,
                      decoration: BoxDecoration(
